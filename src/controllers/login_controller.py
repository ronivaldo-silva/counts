...
class LoginController:
    ...
    def handle_cpf_submit(self, e):
        ...
        if not user:
            ...
            self.view.show_message("CPF não cadastrado.", "red") # Using string "red" or import colors if needed.
            return
        ...
        if user.senha:
            ...
            self.model.senha = user.senha # Store hashed pass (or plain for now) to compare
            ...
            self.view.show_cadastro_dialog('Cadastro de Senha', self.model.nome, self.model.cpf)
    ...
    def handle_password_submit(self, e):
        ...
        if senha:
            ...
            self.view.show_message(f"Login realizado com sucesso! Bem-vindo {self.model.nome}", "green")
            sleep(1)
    ...
    def handle_cadastro_submit(self, senha):
        ...
        if senha:
            ...
            self.view.show_message(f"Senha cadastrada com sucesso para {self.model.nome}", "green")
            self.view.enable_password_field()
        else:
    ...
    def _navigate_after_login(self):
        ...
        if self.model.cpf == "00000000000":
            ...
            gestao_view = GestaoView(self.page, gestao_controller)
        ...
        # Init Dashboard View
        dashboard_view = DashboardView(self.page, dashboard_controller, self.model.nome, self.model.id)
